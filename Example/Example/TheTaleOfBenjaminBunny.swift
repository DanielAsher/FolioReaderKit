...
class TheTaleOfBenjaminBunny : EpubStoryBookReading {
    ...
    func getCoverImage(book: FRBook, parser: [XMLIndexer]) -> String {
        ...
        let coverImage = parser[0]["html"]["body"].children[15]["a"].element!.classifier( "" ).flatMap { $0.getImage() }.joinWithSeparator("")//.....Benjamin Bunny
