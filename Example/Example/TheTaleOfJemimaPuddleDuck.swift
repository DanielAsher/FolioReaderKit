//
//  TheTaleOfJemimaPuddleDuck.swift
...
class TheTaleOfJemimaPuddleDuck : EpubStoryBookReading{
    ...
    func getCoverImage(book: FRBook, parser: [XMLIndexer]) -> String {
        let coverImage = parser[0]["html"]["body"].children[17]["a"].element!.classifier( "" ).flatMap { $0.getImage() }.joinWithSeparator("")
