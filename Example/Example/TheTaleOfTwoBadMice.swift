...
class TheTaleOfTwoBadMice : EpubStoryBookReading {
    ...
    func getStoryPages(parser: [XMLIndexer]) -> [StoryPage]
    {
        ...
        let storyPages = parser
            ...
            .flatMap { xmlDoc -> [StoryPage] in
                ...
                let xmlList = classifier.classifyBodyWithStartAndEndMarkerWithTablePerPage(body, startMarker: self.startMarker, endMarker: self.endMarker,startPos: 2,endPos: -1, pageBreakType: "div")
